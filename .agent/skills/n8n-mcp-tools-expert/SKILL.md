...
The following infrastructure is active for this project:
- **n8n Host**: `https://n8n.akiwaky.cloud/`
- **Webhooks URL**: `https://webhooks.akiwaky.cloud/`
 
When generating webhook URLs or configuring the `N8N_HOST` environment variable, use these values.
